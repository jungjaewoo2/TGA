...
// [azg] ////
// [azg] //// LU factorization of A. It performs the following steps:
// [azg] ////
// [azg] ////   1. Permute columns of A, forming A*Pc, where Pc is a permutation matrix.
// [azg] ////
// [azg] ////   2. Factor A as Pr*A*Pc=L*U using LU decomposition with Pr determined
// [azg] ////      by partial pivoting.
// [azg] ////
// [azg] ////   3. Calculate rcond = 1/cond(A)
// [azg] ////
// [azg] //// This routine is very much like SuperLU's dgssv. Dgssv wasn't sufficient
// [azg] //// because it doesn't produce a condition number estimate.
// [azg] ////
// [azg] //// modified by kmk for superlu 3.0
// [azg] //static void
// [azg] //    msr_super_fact (Matrix * A, int *perm_c, int *perm_r, int *etree,
// [azg] //                    Matrix * L, Matrix * U, int *info, double *rcond)
// [azg] //{
// [azg] //
// [azg] //  char norm[1];
// [azg] //  superlu_options_t slu_options;
// [azg] //  set_default_options (&slu_options);
// [azg] ////   NCformat *Astore;
// [azg] //  Matrix AC;      /* Matrix postmultiplied by Pc */
// [azg] //  int lwork = 0;
// [azg] //  SuperLUStat_t slu_stat;
// [azg] //  // Set defaults
// [azg] //  double anorm;
// [azg] //  int panel_size;   /* panel size */
// [azg] //  int relax;      /* no of columns in a relaxed snodes */
// [azg] //  //
// [azg] //  // Options
// [azg] //  //
// [azg] //  slu_options.Fact = DOFACT;
// [azg] //  panel_size = sp_ienv (1);
// [azg] //  relax = sp_ienv (2);
// [azg] //  StatInit (&slu_stat);
// [azg] ////   Astore = A->Store;
// [azg] //  // Test the input parameters
// [azg] //  *info = 0;
// [azg] //  if (A->nrow != A->ncol || A->nrow < 0)
// [azg] //  {
// [azg] //    *info = -1;
// [azg] //    return;
// [azg] //  }
// [azg] //  //
// [azg] //  // Do the pre-ordering, given a permutation vector.
// [azg] //  //
// [azg] //  sp_preorder (&slu_options, A, perm_c, etree, &AC);
// [azg] //  //
// [azg] //  // Compute the LU factorization of A.
// [azg] //  //
// [azg] //  dgstrf (&slu_options, &AC, relax, panel_size, etree,
// [azg] //           NULL, lwork, perm_c, perm_r, L, U, &slu_stat, info);
// [azg] //  if (*info == 0)
// [azg] //  {
// [azg] //    // estimate the reciprocal of the condition number of A.
// [azg] //    *norm = '1';
// [azg] //    anorm = dlangs (norm, A);
// [azg] //    dgscon (norm, L, U, anorm, rcond, &slu_stat, info);
// [azg] //  }
// [azg] //  // Clean Up.
// [azg] //  Destroy_CompCol_Permuted (&AC);
// [azg] //  StatFree (&slu_stat);
// [azg] //}
