...
C***FIRST EXECUTABLE STATEMENT  ODRDESUBI
...
C***FIRST EXECUTABLE STATEMENT  ODRDETAF
...
C***FIRST EXECUTABLE STATEMENT  ODRDEVJAC
...
C            SET BY THE USER OR COMPUTED BY ODRDETAF.
C   NFEV:    THE NUMBER OF FUNCTION EVALUATIONS.
C   NJEV:    THE NUMBER OF JACOBIAN EVALUATIONS.
C   NP:      THE NUMBER OF FUNCTION PARAMETERS.
C   NQ:      THE NUMBER OF RESPONSES PER OBSERVATION.
...
C***REFER TO DODR,DODRC
C***ROUTINES CALLED  FCN,DCOPY,DDOT,ODRDETAF,DFCTRW,DFLAGS,
...
C...EXTERNAL SUBROUTINES
      EXTERNAL
     +   DCOPY,ODRDETAF,DFCTRW,DFLAGS,DINIWK,DIWINF,DJCK,DODCHK,
...
C***REFER TO  DODR,DODRC
C***ROUTINES CALLED  FCN,DACCES,DCOPY,DDOT,ODRDEVJAC,DFLAGS,DNRM2,DODLM,
...
C***REFER TO  DODR,DODRC
C***ROUTINES CALLED  IDAMAX,DCHEX,ODRDESUBI,DFCTR,DNRM2,DQRDC,DQRSL,DROT,
...
C...EXTERNAL SUBROUTINES
      EXTERNAL
     +   DCHEX,ODRDESUBI,DFCTR,DQRDC,DQRSL,DROT,DROTG,
...
C                TRANS(WRK4)*WRK4 = E = (D**2 + ALPHA*TT**2)
            CALL ODRDESUBI(N,M,WD,LDWD,LD2WD,ALPHA,TT,LDTT,I,WRK4)
            CALL DFCTR(.FALSE.,WRK4,M,M,INF)
            IF (INF.NE.0) THEN
               ISTOPC = 60000
               RETURN
