...
//
  ...
  {BLTIN, "AiryAiPrime", ent_gsl_sf_airy_dai},
  {BLTIN, "AiryBiPrime", ent_gsl_sf_airy_dbi},
  {BLTIN, "AiryZeroAi", ent_gsl_sf_airy_zeroai},
  {BLTIN, "AiryZeroBi", ent_gsl_sf_airy_zerobi},
  {BLTIN, "AiryZeroAiPrime", ent_gsl_sf_airy_zerodai},
  {BLTIN, "AiryZeroBiPrime", ent_gsl_sf_airy_zerodbi},
  ...
  {BLTIN, "Hydrogen", ent_gsl_sf_hydrogen},
  {BLTIN, "Dawson", ent_gsl_sf_dawson},
  {BLTIN, "Debye", ent_gsl_sf_debye},
  {BLTIN, "EllipticE", ent_gsl_sf_elliptic_E},
  {BLTIN, "EllipticF", ent_gsl_sf_elliptic_F},
  {BLTIN, "EllipticK", ent_gsl_sf_elliptic_K},
  {BLTIN, "EllipticP", ent_gsl_sf_elliptic_P},
  {BLTIN, "EllipticD", ent_gsl_sf_elliptic_D},
  {BLTIN, "EllipticRC", ent_gsl_sf_elliptic_RC},
  {BLTIN, "EllipticRD", ent_gsl_sf_elliptic_RD},
  {BLTIN, "EllipticRF", ent_gsl_sf_elliptic_RF},
  {BLTIN, "EllipticRJ", ent_gsl_sf_elliptic_RJ},
  ...
  {BLTIN, "GammaRegularized", ent_gsl_sf_gammareg},
  {BLTIN, "GammaRegularizedC", ent_gsl_sf_gammaregc},
  {BLTIN, "RecGamma", ent_gsl_sf_recgamma},
  {BLTIN, "LogBeta", ent_gsl_sf_logbeta},
  {BLTIN, "Beta", ent_gsl_sf_beta},
  {BLTIN, "BetaRegularized", ent_gsl_sf_betareg},
  {BLTIN, "Pochhammer", ent_gsl_sf_poch},
  {BLTIN, "GegenbauerC", ent_gsl_sf_gegen},
  {BLTIN, "Hypergeometric0F1", ent_gsl_sf_hyperg_0F1},
  {BLTIN, "Hypergeometric1F1", ent_gsl_sf_hyperg_1F1},
  {BLTIN, "HypergeometricU", ent_gsl_sf_hyperg_U},
  ...
  {BLTIN, "LegendreSphericalP", ent_gsl_sf_legendre_sph_Plm},
  {BLTIN, "LegendreConicalP", ent_gsl_sf_legendre_con_Plm},
  {BLTIN, "LegendreH3d", ent_gsl_sf_legendre_h3d},
  {BLTIN, "Digamma", ent_gsl_sf_psi},
  {BLTIN, "PolyGamma", ent_gsl_sf_polygamma},
  ...
  {BLTIN, "_gnuwins", ent_gnuplot_allwin },
  {BLTIN, "gnucmd", ent_gnuplot_cmd },
  {BLTIN, "gnuprint", ent_gnuplot_print },
  // data processing
  {BLTIN, "isabsmono", isAbsMonotone },
  {BLTIN, "isrelmono", isRelMonotone },
  {BLTIN, "localabsmaxi", localAbsMaxIdx },
  {BLTIN, "localabsmini", localAbsMinIdx },
  {BLTIN, "localrelmaxi", localRelMaxIdx },
  {BLTIN, "localrelmini", localRelMinIdx },
...
Bltin rlab_pdf_bltin[] = {
  {BLTIN, "poisson", ent_gsl_pdf_poisson},
  {BLTIN, "geometric", ent_gsl_pdf_geometric},
  {BLTIN, "log", ent_gsl_pdf_log},
  {BLTIN, "binomial", ent_gsl_pdf_binomial},
  {BLTIN, "negbinomial", ent_gsl_pdf_negbinomial},
  {BLTIN, "hypergeom", ent_gsl_pdf_hypergeom},
  {BLTIN, "multinom", ent_gsl_pdf_multinom},
  {BLTIN, "dirichlet", ent_gsl_pdf_dirichlet},
  {BLTIN, "normal", ent_gsl_pdf_normal},
  {BLTIN, "exp", ent_gsl_pdf_exp},
  {BLTIN, "laplace", ent_gsl_pdf_laplace},
  {BLTIN, "cauchy", ent_gsl_pdf_cauchy},
  {BLTIN, "rayleigh", ent_gsl_pdf_rayleigh},
  {BLTIN, "chisq", ent_gsl_pdf_chisq},
  {BLTIN, "t", ent_gsl_pdf_t},
  {BLTIN, "logistic", ent_gsl_pdf_logistic},
  {BLTIN, "normaltail", ent_gsl_pdf_normaltail},
  {BLTIN, "exppow", ent_gsl_pdf_exppow},
  {BLTIN, "rayleightail", ent_gsl_pdf_rayleightail},
  {BLTIN, "gamma", ent_gsl_pdf_gamma},
  {BLTIN, "lognormal", ent_gsl_pdf_lognormal},
  {BLTIN, "F", ent_gsl_pdf_F},
  {BLTIN, "beta", ent_gsl_pdf_beta},
  {BLTIN, "pareto", ent_gsl_pdf_pareto},
  {BLTIN, "weibull", ent_gsl_pdf_weibull},
  {BLTIN, "uniform", ent_gsl_pdf_uniform},
  {BLTIN, "gumbel1", ent_gsl_pdf_gumbel1},
  {BLTIN, "gumbel2", ent_gsl_pdf_gumbel2},
...
Bltin rlab_cpf_bltin[] = {
  {BLTIN, "logistic", ent_gsl_cpf_logistic},
  {BLTIN, "t", ent_gsl_cpf_t},
  {BLTIN, "poisson", ent_gsl_cpf_poisson},
  {BLTIN, "geometric", ent_gsl_cpf_geometric},
  {BLTIN, "binomial", ent_gsl_cpf_binomial},
  {BLTIN, "negbinomial", ent_gsl_cpf_negbinomial},
  {BLTIN, "hypergeom", ent_gsl_cpf_hypergeom},
  {BLTIN, "normal", ent_gsl_cpf_normal},
  {BLTIN, "exp", ent_gsl_cpf_exp},
  {BLTIN, "laplace", ent_gsl_cpf_laplace},
  {BLTIN, "cauchy", ent_gsl_cpf_cauchy},
  {BLTIN, "rayleigh", ent_gsl_cpf_rayleigh},
  {BLTIN, "chisq", ent_gsl_cpf_chisq},
  {BLTIN, "exppow", ent_gsl_cpf_exppow},
  {BLTIN, "gamma", ent_gsl_cpf_gamma},
  {BLTIN, "lognormal", ent_gsl_cpf_lognormal},
  {BLTIN, "F", ent_gsl_cpf_F},
  {BLTIN, "beta", ent_gsl_cpf_beta},
  {BLTIN, "pareto", ent_gsl_cpf_pareto},
  {BLTIN, "weibull", ent_gsl_cpf_weibull},
  {BLTIN, "uniform", ent_gsl_cpf_uniform},
  {BLTIN, "gumbel1", ent_gsl_cpf_gumbel1},
  {BLTIN, "gumbel2", ent_gsl_cpf_gumbel2},
  {0, 0, 0}
};
...
#ifdef HAVE_GLPK
  //
  // Add glpk list of functions
  //
  Btree *glpk_config_list=0;
  ent = ent_Create ();
  ent_SetType (ent, BTREE);
  glpk_config_list = btree_Create ();
  glpk_config_list->isconst = 1;
  ent_data (ent) = glpk_config_list;
  install (0, RLAB_NAME_EMBED_GLPK, ent);
  for (i = 0; rlab_glpk_bltin[i].name; i++)
  {
    ent = ent_Create ();
    ent_SetType (ent, BLTIN);
    ent_data (ent) = &rlab_glpk_bltin[i];
    install (glpk_config_list, rlab_glpk_bltin[i].name, ent);
  }
  //ent_Clean (ent);
#endif
  //
