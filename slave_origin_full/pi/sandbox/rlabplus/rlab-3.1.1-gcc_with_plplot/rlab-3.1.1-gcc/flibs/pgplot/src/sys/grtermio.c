 ...
 */
int GROTER(char *cdev, int *ldev, int *cdev_len)
{
 ...
 */
void GRWTER(int *fd, char *cbuf, int *lbuf, int *cbuf_len)
{
 ...
 */
void GRPTER(int *fd, char *cprom, int *lprom, char *cbuf, int *lbuf,
