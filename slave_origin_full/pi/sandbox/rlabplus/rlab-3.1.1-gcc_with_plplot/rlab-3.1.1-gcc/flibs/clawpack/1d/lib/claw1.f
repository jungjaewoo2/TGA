...
c     ==============================================================
     ...
     &           q,aux,maux,xlower,dx,tstart,tend,dtv,cflv,nv,
     &           method, mthlim, 
...
c          The form of this subroutine is
c  -------------------------------------------------
c     subroutine src1(maxmx,meqn,mbc,mx,xlower,dx,q,maux,aux,t,dt,method)
c     implicit double precision (a-h,o-z)
c     dimension   q(1-mbc:maxmx+mbc, meqn)
c     dimension aux(1-mbc:maxmx+mbc, *)
c  -------------------------------------------------
...
c             call src1(maxmx,meqn,mbc,mx,xlower,dx,q,maux,aux,told,
c     &                 dt2,method)
             endif

c
c        # take a step on the homogeneous conservation law:
         call step1(maxmx,meqn,mwaves,mbc,mx,q,aux,maux,dx,dt,
...
c             call src1(maxmx,meqn,mbc,mx,xlower,dx,q,maux,aux,thalf,
c     &                 dt2,method)
             endif

         if (method(5).eq.1) then
c            # source terms over a full time step:
             call src1(maxmx,meqn,mbc,mx,xlower,dx,q,maux,aux,t,
     &                 dt,method)
             endif
c
c
