...
C
C
C     AUTHORS:    L.BRUGNANO, C.MAGHERINI
C     --------    DIPARTIMENTO DI MATEMATICA "U.DINI"
C                 VIALE MORGAGNI 67/A
C                 50134 FIRENZE
C                 ITALY
C                 E-MAIL: BRUGNANO@MATH.UNIFI.IT,  MAGHERINI@MATH.UNIFI.IT
C
