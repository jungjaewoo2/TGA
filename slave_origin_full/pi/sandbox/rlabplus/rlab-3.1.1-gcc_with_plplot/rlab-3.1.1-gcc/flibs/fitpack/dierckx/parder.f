      subroutine dxparder(tx,nx,ty,ny,c,kx,ky,nux,nuy,x,mx,y,my,z,
...
c
c  input parameters:
c   tx    : real*8 array, length nx, which contains the position of the
c           knots in the x-direction.
c   nx    : integer, giving the total number of knots in the x-direction
c   ty    : real*8 array, length ny, which contains the position of the
c           knots in the y-direction.
c   ny    : integer, giving the total number of knots in the y-direction
c   c     : real*8 array, length (nx-kx-1)*(ny-ky-1), which contains the
...
c   x     : real*8 array of dimension (mx).
...
c           the x-axis. mx >=1.
c   y     : real*8 array of dimension (my).
...
c
c  output parameters:
c   z     : real*8 array of dimension (mx*my).
