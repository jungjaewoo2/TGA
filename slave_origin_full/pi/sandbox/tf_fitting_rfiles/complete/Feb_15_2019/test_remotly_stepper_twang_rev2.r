...
require savepdf2 coarse_motion_linearity2 extract_positions runavg blink_until_pressed
///////////////// NEW ////////////////////////////////////////////////
// while(1) {

DEBUG2=0; // Testing at home without lasers 
if(DEBUG2 != 1){
//////////////////////////////////////////////////////////////////////
...
pause("Press ENTER Continue with Twang test\n");
######################################################################
