...
# [azg] Tue Jan 22 11:23:49 KST 2019
# P4=coarse_motion_linearity2(d, SN);
...
# [azg] Tue Jan 22 11:25:52 KST 2019
savepdf2(P4, SN);
...
# if( DEBUG2 == 1) { system("cp prod_Mar3_inverted.dat /tmp/prod.dat;"); sleep 1; }
# if( DEBUG2 == 1) { system("cp missing_Twang_results.dat /tmp/prod.dat;"); sleep 1; }
# if( DEBUG2 == 1) { system("cp prod_Mar9_inverted_4.dat /tmp/prod.dat;"); sleep 1; }
# if( DEBUG2 == 1) { system("cp prod_Mar9_inverted_5.dat /tmp/prod.dat;"); sleep 1; }
dir="/tmp/";
file1="prod.dat";
...
# k = max(size(BEMF_extract_start))-3 ; // commented out because of changes on Sun Mar 10 10:03:36 KST 2019
