...
gnuwin  (2);
gnutitle  ("Classification Demo");
gnulegend (["Training classes: 1", "2", "3", "4", ...
    "Classification: Parzen: 1", "2", "3", "4", ...
    "KNN("+text(k,"%.0f")+"): 1", "2", "3", "4"]);
gnuformat ([...
    "with points lc rgb 'red' ps 1 pt 1", "with points lc rgb 'blue' ps 1 pt 1", ...
    "with points lc rgb 'green' ps 1 pt 1", "with points lc rgb 'orange' ps 1 pt 1", ...
    "with points lc rgb 'red' ps 4 pt 4", "with points lc rgb 'blue' ps 4 pt 4", ...
    "with points lc rgb 'green' ps 4 pt 4", "with points lc rgb 'orange' ps 4 pt 4", ...
    "with points lc rgb 'red' ps 4 pt 3", "with points lc rgb 'blue' ps 4 pt 3", ...
    "with points lc rgb 'green' ps 4 pt 3", "with points lc rgb 'orange' ps 4 pt 3", ...
[]]);
gnuplot (tp);
