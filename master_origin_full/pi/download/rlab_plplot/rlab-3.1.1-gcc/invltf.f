...
C     .. Local Scalars ..
      ...
      LOGICAL RIV
! fuck fuck fuck - these old farts and their codes. old farts assume that
! the compiler saves the local variables between the calls:
! here MX !!!!
      SAVE
! bad programmers bad programmers no medicare for you!
! kmk, IX-2008
C     ..
C     .. Intrinsic Functions ..
