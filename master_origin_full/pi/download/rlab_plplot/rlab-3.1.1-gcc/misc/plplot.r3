...
// PLPLOT_COLOR_SCHEME = "std"; //plplot's standard black background, ..
// PLPLOT_COLOR_SCHEME = "bw"; //plplot's white on black
...
modify_color0_scheme = function(color_scheme)
{
  ...
  if (color_scheme == "std")
  {
    ...
    PLPLOT_COLOR_RGB = PLPLOT_COLOR_RGB_DEFAULT; // background <- black
    PLPLOT_COLOR_RGB_NAMES = PLPLOT_COLOR_RGB_DEFAULT_NAMES;
...
plplot3 = function ( arg1, arg2, arg3 )
{
  ...
  else
  {
    ...
    else if (PLPLOT_PLOT_WINDOWS.[PLPLOT_ACTIVE_WIN].aspect[p] != 0)
    {
      _plvasp (PLPLOT_PLOT_WINDOWS.[PLPLOT_ACTIVE_WIN].aspect[p]);
    }
    else
