...
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine dblendstep4(m,y0,f0,Y,F,h,theta,ipvt,Z,gamma,
...
C -------------------------------------------------------------------
      ...
      subroutine dblendstep6(m,y0,f0,Y,F,h,theta,ipvt,Z,gamma,
     &                      ldlu,mljac,mujac,ijob,imas,
     &                                ldmas,mlmas,mumas,M0,MZ)
c
...
C -------------------------------------------------------------------
      ...
      subroutine dblendstep8(m,y0,f0,Y,F,h,theta,ipvt,Z,gamma,
     &                            ldlu,mljac,mujac,ijob,imas,
     &                               ldmas,mlmas,mumas,M0,MZ)
c
...
C -------------------------------------------------------------------
      ...
      subroutine dblendstep10(m,y0,f0,Y,F,h,theta,ipvt,Z,gamma,
     &                             ldlu,mljac,mujac,ijob,imas,
     &                                ldmas,mlmas,mumas,M0,MZ)
c
...
C -------------------------------------------------------------------
      ...
      subroutine dblendstep12(m,y0,f0,Y,F,h,theta,ipvt,Z,gamma,
     &                      ldlu,mljac,mujac,ijob,imas,
     &                                ldmas,mlmas,mumas,M0,MZ)
c
...
C -------------------------------------------------------------------
      ...
      subroutine dlocalerr4(m,f0,F,h,Z,scal,nerr,nerrup,nlinsys,
...
C -------------------------------------------------------------------
      ...
      subroutine dlocalerr(m,f0,F,h,Z,scal,nerr,nerrup,nlinsys,
     &                    theta,vmax,ipvt,ldlu,mljac,mujac,ijob,
     &                    imas,ldmas,mlmas,mumas,M0,k,ord_ind,
     &                    index1,index2)
c
...
C -------------------------------------------------------------------
      ...
      subroutine derrdown(m,f0,F,h,Z,scal,nerrdown,nlinsys,vmax,
...
C ---------------------- SUBROUTINE ERRUP ------------------------------
      ...
      subroutine derrup(m,k,ord_ind,Z,h,h0,h00,vmax,nerrup,scal,
