 ...
 *-
 */
int GROFIL(char *fname, int *fname_len)
{
//   fprintf(stderr, "grfileio.c: GROFIL: Enter\n");
...
//   fprintf(stderr, "grfileio.c: GROFIL: 1 fname=%s,len=%i\n",fname,slen);
 ...
 */
//   fprintf(stderr, "grfileio.c: GROFIL: 1\n");
...
//     fprintf(stderr, "grfileio.c: GROFIL: 1 buff=%s,len=%i\n",buff,slen);
...
//   fprintf(stderr, "grfileio.c: GROFIL: Exit\n");
  return fd;
}
 ...
 *-
 */
int GRWFCH(int *fd, char *buf, int *buf_len)
{
  return write(*fd, (void *) buf, (int *)buf_len);
}
