...
C USE LINEAR PREDICTOR ALONG TANGENT DIRECTION TO START NEWTON ITERATION.
 ...
 70   CALL DCOPY(NP1,Y,1,W,1)
      CALL DAXPY(NP1,H,YP,1,W,1)
      CALL DCOPY(NP1,W,1,Z0,1)
      DO 200 JUDY=1,LITFH
        RHOLEN=-1.0
...
C
600   CALL DCOPY(NP1,YP,1,YPOLD,1)
      CALL DCOPY(NP1,Y,1,YOLD,1)
      CALL DCOPY(NP1,W,1,Y,1)
      CALL DCOPY(NP1,WP,1,YP,1)
      CALL DAXPY(NP1,-ONE,YOLD,1,W,1)      
C UPDATE ARC LENGTH.
      HOLD=DNRM2(NP1,W,1)
      S=S+HOLD
C
...
700   CALL DCOPY(NP1,Z0,1,TZ,1)
      CALL DAXPY(NP1,-ONE,Y,1,TZ,1)
      CALL DCOPY(NP1,Z1,1,W,1)
      CALL DAXPY(NP1,-ONE,Y,1,W,1)
