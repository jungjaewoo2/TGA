...
c    t   : real*8 array of dimension at least (n). before entry, this
...
c    e   : real*8 array of dimension at least (n). before entry, e(j)
...
c          unchanged on exit.
c    c   : real*8 array of dimension at least (n).
...
c    sx  : real*8 array of dimension at least m. on succesful exit
...
c   wrk  : real*8 array of dimension at least  m*4+n*7+maxbin*(maxbin+n+1)
