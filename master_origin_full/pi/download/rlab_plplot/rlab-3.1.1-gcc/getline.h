...
extern Ent *ent_string_capitalize (int nargs, Datum args[]);
...
extern Ent *ent_Unpack(int nargs, Datum args[]);
...
MDR * mdr_ReadGeneric (FILE * fn, int block_size,
                       ...
                       MDR *set_userows, MDR *set_usecols, MDS *start, MDS *stop, int skipdatarows);
