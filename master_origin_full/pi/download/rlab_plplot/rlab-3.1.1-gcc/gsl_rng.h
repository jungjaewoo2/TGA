...
#define RLAB_IRNG_DEFAULT_INDEX 7 /* gfsr4 */
#define RLAB_IRNG_DEFAULT_NAME "gfsr4" /* gfsr4 */
#define RLAB_GSL_IRNG_DEFAULT gsl_rng_gfsr4

typedef struct _rlab_irand
{
  int index;
  gsl_rng *generator;
  double seed;
