...
extern Ent * ent_plplot_plprec(int nargs, Datum args[]);
extern Ent * ent_plplot_plstring(int nargs, Datum args[]);
extern Ent * ent_plplot_plstring3(int nargs, Datum args[]);
extern Ent * ent_plplot_plstyl(int nargs, Datum args[]);
extern Ent * ent_plplot_plspal1(int nargs, Datum args[]);
extern Ent * ent_plplot_plspal0(int nargs, Datum args[]);
extern Ent * ent_plplot_plsmin(int nargs, Datum args[]);
extern Ent * ent_plplot_plsmaj(int nargs, Datum args[]);
extern Ent * ent_plplot_plshades(int nargs, Datum args[]);
