...
extern Ent * ent_3d_rotate  (int nargs, Datum args[]);
extern Ent * ent_rotate_x  (int nargs, Datum args[]);
extern Ent * ent_rotate_y  (int nargs, Datum args[]);
extern Ent * ent_rotate_z  (int nargs, Datum args[]);
extern Ent * ent_bwlabel    (int nargs, Datum args[]);
extern Ent * ent_bwblobs    (int nargs, Datum args[]);
