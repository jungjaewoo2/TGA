...
extern void dgstrf (superlu_options_t *, Matrix *, double,
                    ...
                    Matrix * L, Matrix * U, int *info, double *rcond)
{
  ...
  *info = 0;
  ...
  //
  dgstrf (&slu_options, &AC, drop_tol, relax, panel_size, etree,
...
Ent * SpFactor_BF (int nargs, Datum args[])
{
  void *rval = 0;
  Ent *e1=0, *rent;
  rent = 0;
...
Btree * msr_Factor (MSR * a, char *type)
{
  Btree *x = msr_SpFactor (a);
  return (x);
}
