...
#undef  THIS_SOLVER
#define THIS_SOLVER "vector_create_op"
Datum vector_create_op (int n, Datum d1, Datum d2, Datum d3)
{
  Datum new;
  Ent *e1=0, *e2=0, *e3=0, *er=0;
  ...
  if (n == 3)
  {
    ...
    ent_data (er) = mdr_vector_create (ent_data (e3), ent_data (e2), ent_data (e1));
  }
  else
  {
...
#undef  THIS_SOLVER 
#define THIS_SOLVER "vector_append"
Datum vector_append (Datum d1, Datum d2)
{
  Datum new;
