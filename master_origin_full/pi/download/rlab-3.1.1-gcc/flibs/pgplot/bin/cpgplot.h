...
void cpgconl(const float *a, int idim, int jdim, int i1, int i2, int j1, int j2, const float *c, int nc, const float *tr, const int *cparam, int idxc, const char *label, float ts, int intval, int minint);
void cpgcons(const float *a, int idim, int jdim, int i1, int i2, int j1, int j2, const float *c, int nc, const float *tr);
void cpgcont(const float *a, int idim, int jdim, int i1, int i2, int j1, int j2, const float *c, int nc, const float *tr, const int *cparam);
...
void cpgrgbfor(const float *a, int idim, int jdim, int i1, int i2, int j1, int j2, float fg, float bg, const float *tr, int *frgb);
