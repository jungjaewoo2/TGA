...
C
      ...
      DO 26 I=IA,IB-1
          II = I-IA+1
          IF (FLAGS(II,JJ,1) .AND. (Z(I,J).GT.Z(I+1,J))) THEN
              WRITE (*,*) 'BOTTOMEDGE'
...
C
      ...
      DO 27 J=JA,JB-1
          JJ = J-JA+1
          IF (FLAGS(II,JJ,2) .AND. (Z(I,J).GT.Z(I,J+1))) THEN
!               WRITE (*,*) 'RIGHTEDGE'
              CALL PGCN01(Z, MX, MY, IA, IB, JA, JB,
...
C
      ...
      DO 28 I=IB-1,IA,-1
          II = I-IA+1
          IF (FLAGS(II,JJ,1) .AND. (Z(I+1,J).GT.Z(I,J))) THEN
!               WRITE (*,*) 'TOPEDGE'
              CALL PGCN01(Z, MX, MY, IA, IB, JA, JB,
...
C
      ...
      DO 29 J=JB-1,JA,-1
          JJ = J-JA+1
          IF (FLAGS(II,JJ,2)  .AND. (Z(I,J+1).GT.Z(I,J))) THEN
!               WRITE (*,*) 'LEFTEDGE'
              CALL PGCN01(Z, MX, MY, IA, IB, JA, JB,
