...
extern MDC * mdc_CreateEmpty (int nrow, int ncol);
...
extern Complex mdc0_safe(MD *m, int k, int j);
extern Complex mdc1(MD *m, int k, int j);
extern Complex mdc1_safe(MD *m, int k, int j);
extern Complex mdcV0(MD *m, int k);
extern double mdcV0r(MD *m, int k);
extern double mdcV0i(MD *m, int k);
extern Complex mdcV1(MD *m, int k);
extern double mdcV1r(MD *m, int k);
extern double mdcV1i(MD *m, int k);
...
//
// Row-dominant addresses:
// 
// Index matrices from 0
#define Mdc0_rd(m,k,j)     (((Complex *)((MDC *)(m)->d))[(k)*(((MDC *)(m))->ncol)+(j)])
#define Mdc0r_rd(m,k,j)    (RE(((Complex *)((MDC *)(m)->d))[(k)*(((MDC *)(m))->ncol)+(j)]))
#define Mdc0i_rd(m,k,j)    (IM(((Complex *)((MDC *)(m)->d))[(k)*(((MDC *)(m))->ncol)+(j)]))
// Index matrices from 0
#define Mdc1_rd(m,k,j)    (((Complex *)((MDC *)(m)->d))[(k-1)*(((MDC *)(m))->ncol)+(j-1)])
#define Mdc1r_rd(m,k,j)   (RE(((Complex *)((MDC *)(m)->d))[(k-1)*(((MDC *)(m))->ncol)+(j-1)]))
#define Mdc1i_rd(m,k,j)   (IM(((Complex *)((MDC *)(m)->d))[(k-1)*(((MDC *)(m))->ncol)+(j-1)]))
