/*
 * coarse_40s_MCP3202.c
 * [azg] Fri Jul  8 09:12:52 KST 2022
 * run for 40 s (tga with fast homing to photo interrupter)
...
#define SAMPLES 95000  // Number of samples to take, ~ 40 sec 
...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   system("/bin/rm /tmp/ADCDONE 2>/dev/null;");
   ...
   system("/usr/bin/touch  /tmp/ADCDONE 2>/dev/null;");
