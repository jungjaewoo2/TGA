...
# skew must be much(?) bigger in the last two intervals if coils are wired correctly and magnets are not reversed
...
fprintf(fn2,"Coil2Rdc=%2.2f;\nCoil2short_pass=\"%s\";\nSkewGain=%2.2f;\nSkewTravel=%2.2f;\nSkewSeq=\"%s\";\nSkewPol=\"%s\";\n", Rdc_final,Short_pass,skew_gain,skew_travel,SKEW_SEQ,SKEW_POL);
close(fn2);
##################################################
