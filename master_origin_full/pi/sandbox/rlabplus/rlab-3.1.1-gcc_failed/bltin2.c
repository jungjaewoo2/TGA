...
static OpDef max_1_method[NCL];
static OpDef max_2_method[NCL][NCL];
static OpDef min_1_method[NCL];
static OpDef min_2_method[NCL][NCL];
...
class_bltin2_init (void)
{
  ...
  max_1_method[MATRIX_DENSE_REAL].type = MATRIX_DENSE_REAL;
  max_1_method[MATRIX_DENSE_REAL].op = (void *) mdr_MinMax1_ValIdx;

  max_1_method[MATRIX_DENSE_COMPLEX].type = MATRIX_DENSE_COMPLEX;
  max_1_method[MATRIX_DENSE_COMPLEX].op = (void *) mdc_Max1;

  max_1_method[MATRIX_SPARSE_REAL].type = MATRIX_DENSE_REAL;
  max_1_method[MATRIX_SPARSE_REAL].op = (void *) msr_Max1;

  max_1_method[MATRIX_SPARSE_COMPLEX].type = MATRIX_DENSE_COMPLEX;
  max_1_method[MATRIX_SPARSE_COMPLEX].op = (void *) msc_Max1;

  max_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_REAL].type = MATRIX_DENSE_REAL;
  max_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_REAL].op = (void *) mdr_Max2;

  max_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_COMPLEX].type =
    MATRIX_DENSE_COMPLEX;
  max_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_COMPLEX].op =
    (void *) mdr_mdc_Max2;

  max_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_COMPLEX].type =
    MATRIX_DENSE_COMPLEX;
  max_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_COMPLEX].op =
    (void *) mdc_Max2;

  max_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_REAL].type =
    MATRIX_DENSE_COMPLEX;
  max_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_REAL].op =
    (void *) mdc_mdr_Max2;
  ...
  min_1_method[MATRIX_DENSE_REAL].type = MATRIX_DENSE_REAL;
  min_1_method[MATRIX_DENSE_REAL].op = (void *) mdr_MinMax1_ValIdx;

  min_1_method[MATRIX_DENSE_COMPLEX].type = MATRIX_DENSE_COMPLEX;
  min_1_method[MATRIX_DENSE_COMPLEX].op = (void *) mdc_Min1;

  min_1_method[MATRIX_SPARSE_REAL].type = MATRIX_DENSE_REAL;
  min_1_method[MATRIX_SPARSE_REAL].op = (void *) msr_Min1;

  min_1_method[MATRIX_SPARSE_COMPLEX].type = MATRIX_DENSE_COMPLEX;
  min_1_method[MATRIX_SPARSE_COMPLEX].op = (void *) msc_Min1;

  min_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_REAL].type = MATRIX_DENSE_REAL;
  min_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_REAL].op = (void *) mdr_Min2;

  min_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_COMPLEX].type =
    MATRIX_DENSE_COMPLEX;
  min_2_method[MATRIX_DENSE_REAL][MATRIX_DENSE_COMPLEX].op =
    (void *) mdr_mdc_Min2;

  min_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_COMPLEX].type =
    MATRIX_DENSE_COMPLEX;
  min_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_COMPLEX].op =
    (void *) mdc_Min2;

  min_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_REAL].type =
    MATRIX_DENSE_COMPLEX;
  min_2_method[MATRIX_DENSE_COMPLEX][MATRIX_DENSE_REAL].op =
    (void *) mdc_mdr_Min2;
...
#define METHOD  max_1_method
#define METHOD2 max_2_method
Ent * THIS_SOLVER_ENT (int nargs, Datum args[])
{
  ...
  else if (nargs == 2)
  {
    ...
    rtype = METHOD2[type1][type2].type;
    vfptr = (VFPTR) METHOD2[type1][type2].op;
...
#define METHOD  min_1_method
#define METHOD2 min_2_method
Ent * THIS_SOLVER_ENT (int nargs, Datum args[])
{
  int type1, type2, rtype;
  void *rval;
...
Ent *
Solve (int nargs, Datum args[])
{
  void *rval;
  int rtype, type1, type2;
  char *ctype=0;
  void *(*vfptr) ();
  Ent *e1=0, *e2=0, *e3=0, *rent;
...
Ent *
ent_Atanh (int nargs, Datum args[])
{
  Ent *e1=0, *rent;
