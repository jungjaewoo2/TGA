      SUBROUTINE STL2(X, Y, E, M, U, V, W, K, IP)
C toms/510
C for: piecewise linear approximation of given data points.
C The approximant need not be continuous, and distinct tolerances
C may be specified for each data point
C by: D.G. Wilson
C ref: ACM TOMS 2 (1976) 388-391C PIECEWISE LINEAR APPROXIMATIONS OF FEWEST
