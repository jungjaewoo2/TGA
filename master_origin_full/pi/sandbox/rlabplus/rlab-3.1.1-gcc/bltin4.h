...
extern Ent *localAbsMaxIdx (int nargs, Datum args[]);
extern Ent *localAbsMinIdx (int nargs, Datum args[]);
extern Ent *localRelMaxIdx (int nargs, Datum args[]);
extern Ent *localRelMinIdx (int nargs, Datum args[]);
