...
%type  <n_int>  if_stmt while_stmt for_stmt return_stmt do_stmt switch_stmt
...
;
  ...
  */
if_stmt:
if cond newlines c_stmt end %prec IF
{
 /*
...
| if cond newlines left_brace cstmts else cstmts right_brace end %prec ELSE
{
  $$ = $1;
  code_sp ($2 + 1, $7 - ($2 + 1));
  code_sp ($6 + 1, $9 - ($6 + 1));
