...
if(!exist(DEBUG)) { # BEGIN DEBUG SKIP
// Laser controller //////////////////////////////////////////////////
attr=<<>>;
attr.devname = "ttyUSB";
...
} // do not overwrite during fake runs DEBUG
################# TWANG STARTS HERE ##################
...
if(!isfile(fn1)){fprintf(fn1,"%s\n","SN,OPERATOR,BEMFfres,BEMFdecay,BEMFresrise,Rdc_final,Short_pass,,LASERfres,LASERdecay,LASERresrise,Gain,travel");}
