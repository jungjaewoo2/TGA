...
system("cp  /tmp/datcoarse.dat /var/www/html/datcoarse.dat;"); sleep 1; 
############
...
if( DEBUG2 == 1) { system("cp current.prod.dat /tmp/prod.dat;"); sleep 1; }
dir="/tmp/";
file1="prod.dat";
...
skip=120; # *** last used
skip=80;
skip=80+28; // +28 because now detecting leading and not trailing pulse edge 
# skip=195;
...
////////////////////////// AUG 28 ////////////////////////////////////
////////////////////////// JAN 20 ////////////////////////////////////
// TADDR1="28-02131ace25aa"; // in specs.r
